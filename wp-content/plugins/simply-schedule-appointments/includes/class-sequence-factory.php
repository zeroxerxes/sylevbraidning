...
class SSA_Sequence_Factory extends SSA_Sequence {
	public static function create( $args ) {
		$sequence = new SSA_Sequence( array(
			SSA_Period::create_from_period( new Period( '2116-01-01 11:00:00', '2116-01-01 13:00:00') ),
			SSA_Period::create_from_period( new Period( '2115-01-01 11:00:00', '2115-01-01 13:00:00') ),
		) );
