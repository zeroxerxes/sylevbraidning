...
class SSA_Locales {
	...
	public function __construct() {
		...
		$de_ch_informal = new SSA_Locale();
		$de_ch_informal->english_name = 'German (Switzerland, Informal)';
		$de_ch_informal->native_name = 'Deutsch (Schweiz, Du)';
		$de_ch_informal->lang_code_iso_639_1 = 'de';
		$de_ch_informal->country_code = 'ch';
		$de_ch_informal->wp_locale = 'de_CH_informal';
		$de_ch_informal->slug = 'de-ch_informal';
		$de_ch_informal->google_code = 'de';
		$de_ch_informal->variant = 'informal';
		...
		$nl_formal = new SSA_Locale();
		$nl_formal->english_name = 'Dutch (Formal)';
		$nl_formal->native_name = 'Nederlands (Formeel)';
		$nl_formal->lang_code_iso_639_1 = 'nl';
		$nl->lang_code_iso_639_2 = 'nld';
		$nl_formal->country_code = 'nl';
		$nl_formal->wp_locale = 'nl_NL_formal';
		$nl_formal->slug = 'nl_formal';
		$nl_formal->variant = 'formal';
		$nl_formal->google_code = 'nl';
		$nl_formal->facebook_locale = 'nl_NL_formal';
	...
	public static function &instance() {
		if ( ! isset( $GLOBALS['ssa_gp_locales'] ) )
			$GLOBALS['ssa_gp_locales'] = new SSA_Locales;

		return $GLOBALS['ssa_gp_locales'];
	}
