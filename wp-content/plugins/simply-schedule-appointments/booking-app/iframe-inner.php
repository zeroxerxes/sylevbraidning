...
<html <?php echo ssa_get_language_attributes(); ?>>
  <head>
    ...
    <style>
      ...
      html .ssa_booking_initial_spinner-container .ssa_booking_initial_spinner {
        border: 4px solid <?php echo $ssa_styles['background']; ?>;
        border-top-color:  <?php echo $ssa_styles['accent_color']; ?>;
        border-radius: 50%;
        width: 40px;
        height: 40px;
  ...
  <script type="text/javascript">
    ...
    var ssa_embed_settings = <?php echo json_encode (isset($_GET['redirect_post_id']) && !empty($_GET['redirect_post_id']) ? array("redirect_post_id" => esc_attr($_GET['redirect_post_id']), "redirect_url" => get_permalink(esc_attr($_GET['redirect_post_id']))):array("redirect_url"=>'',"redirect_post_id"=>'')); ?>;
  </script>
