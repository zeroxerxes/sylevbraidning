    ...
    <table class="wp-list-table widefat plugins" style="margin-top:10px; border:none;">
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_most_reacted_comment" id="wc_most_reacted_comment"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_hottest_comment_thread" id="wc_hottest_comment_thread"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label for="wc_inline_comments"><?php esc_html_e("Inline Comments", "wpdiscuz"); ?></label>
            </th>
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_inline_comments"]); ?>"
                                   name="wc_inline_comments" id="wc_inline_comments"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label for="wc_email_text"><?php esc_html_e("Email Field", "wpdiscuz"); ?></label></th>
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_email_text"]); ?>"
                                   name="wc_email_text" id="wc_email_text"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label for="wc_subscribe_anchor"><?php esc_html_e("Subscribe", "wpdiscuz"); ?></label></th>
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_subscribe_anchor"]); ?>"
                                   name="wc_subscribe_anchor" id="wc_subscribe_anchor"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label for="wc_notify_of"><?php esc_html_e("Notify of", "wpdiscuz"); ?></label></th>
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_notify_of"]); ?>"
                                   name="wc_notify_of" id="wc_notify_of"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_notify_on_new_comment" id="wc_notify_on_new_comment"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_notify_on_all_new_reply" id="wc_notify_on_all_new_reply"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_newest"]); ?>"
                                   name="wc_newest" id="wc_newest"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label for="wc_oldest"><?php esc_html_e("Oldest", "wpdiscuz"); ?></label></th>
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_oldest"]); ?>"
                                   name="wc_oldest" id="wc_oldest"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label for="wc_most_voted"><?php esc_html_e("Most Voted", "wpdiscuz"); ?></label></th>
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_most_voted"]); ?>"
                                   name="wc_most_voted" id="wc_most_voted"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_form_subscription_submit" id="wc_form_subscription_submit"/></td>
        </tr>
        </tbody>
    </table>
</div>