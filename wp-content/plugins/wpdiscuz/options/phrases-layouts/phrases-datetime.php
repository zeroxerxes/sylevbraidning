...
<div>
    ...
    <table class="wp-list-table widefat plugins" style="margin-top:10px; border:none;">
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_year_text"]); ?>"
                                   name="wc_year_text" id="wc_year_text"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_month_text"]); ?>"
                                   name="wc_month_text" id="wc_month_text"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_day_text"]); ?>"
                                   name="wc_day_text" id="wc_day_text"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_hour_text"]); ?>"
                                   name="wc_hour_text" id="wc_hour_text"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_minute_text"]); ?>"
                                   name="wc_minute_text" id="wc_minute_text"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_second_text"]); ?>"
                                   name="wc_second_text" id="wc_second_text"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_ago_text"]); ?>"
                                   name="wc_ago_text" id="wc_ago_text"/></td>
        </tr>
        </tbody>
    </table>
</div>