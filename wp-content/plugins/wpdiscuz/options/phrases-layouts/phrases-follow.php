...
<div>
    ...
    <table class="wp-list-table widefat plugins" style="margin-top:10px; border:none;">
        <tbody>
        <tr valign="top">
            <th scope="row"><label for="wc_follow_user"><?php esc_html_e("Follow this user", "wpdiscuz"); ?></label>
            </th>
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_follow_user"]); ?>"
                                   name="wc_follow_user" id="wc_follow_user"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label for="wc_unfollow_user"><?php esc_html_e("Unfollow this user", "wpdiscuz"); ?></label>
            </th>
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_unfollow_user"]); ?>"
                                   name="wc_unfollow_user" id="wc_unfollow_user"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_follow_email_confirm" id="wc_follow_email_confirm"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_follow_email_confirm_fail" id="wc_follow_email_confirm_fail"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_follow_login_to_follow" id="wc_follow_login_to_follow"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text" name="wc_follow_confirm_email_subject"
                                   id="wc_follow_confirm_email_subject"
                                   value="<?php echo esc_attr($this->phrases["wc_follow_confirm_email_subject"]); ?>"/>
            </td>
        </tr>
        <tr valign="top">
            <th scope="row">
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text" name="wc_follow_email_subject" id="wc_follow_email_subject"
                                   value="<?php echo esc_attr($this->phrases["wc_follow_email_subject"]); ?>"/></td>
        </tr>
        <tr valign="top">
            <th scope="row">
