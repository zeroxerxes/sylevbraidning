...
<div>
    ...
    <table class="wp-list-table widefat plugins" style="margin-top:10px; border:none;">
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_connect_with"]); ?>"
                                   name="wc_connect_with" id="wc_connect_with"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_social_login_agreement_label" id="wc_social_login_agreement_label"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
        ...
        <tr valign="top">
            <th scope="row"><label for="wc_agreement_button_agree"><?php esc_html_e("Agree", "wpdiscuz"); ?></label>
            </th>
            <td colspan="3"><input type="text" id="wc_agreement_button_agree" name="wc_agreement_button_agree"
                                   value="<?php echo esc_attr($this->phrases["wc_agreement_button_agree"]); ?>"></td>
        </tr>
        </tbody>
    </table>
</div>