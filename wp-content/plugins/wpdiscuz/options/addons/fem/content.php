...
if (!$isFemExists) {
    ...
    <div style="width:100%;">
        ...
        <p style="border: 1px dotted #07B290; padding: 15px; font-size: 14px; text-align: center; margin: 10px; background: #EFFFF5">
            wpDiscuz Frontend Moderation is an all in one powerful yet simple admin toolkit to moderate comments on
            front-end.
            This is a demo admin page of the wpDiscuz Frontend Moderation addon. You can buy this addon on gVectors Team
            Store.
            <br>
        ...
        <table class="wp-list-table widefat plugins" style="margin-top:10px; border:none; opacity: 0.6;">
            ...
            <tr valign="top">
                ...
                <td>
                    <input class="wpdiscuz-color-picker regular-text"
                           style="padding: 3px 5px; background-color: rgb(255, 255, 255); color: rgb(34, 34, 34);"
                           value="#FFFFFF" id="mod_form_bg_color" name="" placeholder="Example: #00FF00" type="text">
                </td>
            </tr>
            <tr valign="top">
                <th>
                ...
                <td>
                    <input class="wpdiscuz-color-picker regular-text"
                           style="padding: 3px 5px; background-color: rgb(51, 51, 51); color: rgb(221, 221, 221);"
                           value="#333333" id="mod_form_border_color" name="" placeholder="Example: #00FF00"
                           type="text">
                </td>
            </tr>
            <tr valign="top">
                ...
                <td>
                    <input class="wpdiscuz-color-picker regular-text"
                           style="padding: 3px 5px; background-color: rgb(221, 221, 221); color: rgb(34, 34, 34);"
                           value="#DDDDDD" id="mod_text_bottom_line_color" name="" placeholder="Example: #00FF00"
                           type="text">
                </td>
            </tr>
            <tr scope="row">
            ...
            <tr valign="top">
                ...
                <td>
                    <input style="padding: 3px 5px; width: 100%;" value="Moderate" id="mod_phrase_moderate" name=""
                           type="text">
                </td>
            </tr>
            <tr valign="top">
                ...
                <td>
                    <input style="padding: 3px 5px; width: 100%;" value="Approve" id="mod_phrase_approve" name=""
                           type="text">
                </td>
            </tr>
            <tr valign="top">
                ...
                <td>
                    <input style="padding: 3px 5px; width: 100%;" value="Unapprove" id="mod_phrase_unapprove" name=""
                           type="text">
                </td>
            </tr>
            <tr valign="top">
                ...
                <td>
                    <input style="padding: 3px 5px; width: 100%;" value="Trash" id="mod_phrase_trash" name=""
                           type="text">
                </td>
            </tr>
            <tr valign="top">
            ...
            <tr valign="top">
                ...
                <td>
                    <input style="padding: 3px 5px; width: 100%;" value="Email" id="mod_phrase_email" name=""
                           type="text">
                </td>
            </tr>
            <tr valign="top">
            ...
            <tr valign="top">
                ...
                <td>
                    <input style="padding: 3px 5px; width: 100%;" value="Blacklist" id="mod_phrase_blacklist" name=""
                           type="text">
                </td>
            </tr>
            <tr valign="top">
                ...
                <td>
                    <input style="padding: 3px 5px; width: 100%;" value="Delete" id="mod_phrase_delete" name=""
                           type="text">
                </td>
            </tr>
            <tr valign="top">
                ...
                <td>
                    <input style="padding: 3px 5px; width: 100%;" value="Restore" id="mod_phrase_restore" name=""
                           type="text">
                </td>
            </tr>
            <tr valign="top">
                ...
                <td>
                    <input style="padding: 3px 5px; width: 100%;" value="Not Spam" id="mod_phrase_not_spam" name=""
                           type="text">
                </td>
            </tr>
