...
if (!$isUcmExists) {
    ...
    <div>
        <div class="ucm-inner">
            <h3 style="padding:5px 10px 15px 10px; margin:0px; text-align:right; border-bottom:1px solid #ddd; margin:0px 0px 20px auto; font-weight:normal;max-width:60%;">
                Addon - User and Comment Mentioning</h3>
            <p style="border: 1px dotted #07B290; padding: 15px; font-size: 14px; text-align: center; margin: 10px; background: #EFFFF5">
                wpDiscuz User &amp; Comment Mentioning addon allows to mention comments and users in comment text using
                #comment-id and @username tags.
                This is a demo admin page of the wpDiscuz User &amp; Comment Mentioning addon. You can buy this addon on
                gVectors Team Store.
                <br><a href="https://gvectors.com/product/wpdiscuz-user-comment-mentioning/" target="_blank"
                       style="padding: 6px 15px; background: #07B290; color: #fff; display: inline-block; margin: 15px 5px 5px 5px;">Addon
                    Details and Screenshots &raquo;</a>
            </p>
            <table style="opacity: 0.6;">
                ...
                <tr valign="top">
                    <th scope="row" colspan="2" style="border-top:3px solid #ddd;">
                        <h3 style="padding-bottom:5px; padding-top:20px; font-weight:normal; margin:0px; text-align:right;">
                            Comment mentioning through #comment-id</h3>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <input type="text" name="" class="text-inner" value="Your Comment has been mentioned"
                               id="author_mail_subject"/>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row">
            ...
            Comment URL: [commentURL]</textarea>
                ...
                <tr valign="top">
                    <th scope="row" colspan="2" style="border-top:3px solid #ddd;">
                        <h3 style="padding-bottom:5px; padding-top:20px; font-weight:normal; margin:0px; text-align:right;">
                            User mentioning through @username</h3>
