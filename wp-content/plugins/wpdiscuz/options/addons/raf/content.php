...
if (!$isRafExists) {
    ?>
    <style>
        .flag-inner input[type=text], .flag-inner input[type=email] {
            height: 30px;
            width: 95%;
            padding: 3px 5px;
        }

        .flag-inner input[type=number] {
            height: 30px;
            padding: 3px 5px;
            width: 80px;
        }
        ...
        .add_new {
            border: 1px solid rgba(0, 91, 255, 0.34);
            border-radius: 4px;
    ...
    <div class="flag-inner">
        ...
        <p style="border: 1px dotted #07B290; padding: 15px; font-size: 14px; text-align: center; margin: 10px; background: #EFFFF5">
            wpDiscuz Report &amp; Flagging addon is a comment reporting tools. Auto-moderates comments based on number
            of flags and dislikes.
            This is a demo admin page of the wpDiscuz Report &amp; Flagging addon. You can buy this addon on gVectors
            Team Store.
            <br>
        ...
        <table style="opacity: 0.6;">
            ...
            <tr valign="top">
                <th scope="row" style="width:55%;">
                    ...
                    <p class="wpd-info">If this option is disabled, comment auto-moderation will only be based on down
                        votes / dislikes.</p>
                </th>
                <td>
            ...
            <tr valign="top">
                <th scope="row">
                    ...
                    <p class="wpd-info">For security reasons comment reporting form is disabled for guests by default.
                        Guests are still able to flag without sending message. However you can enable this for guests
            ...
            <tr valign="top">
                <th scope="row">
                    ...
                    <p class="wpd-info">This will automatically Unapprove or Trash comments which reached the maximum
                        number of flags or dislikes set below</p>
                </th>
                <td>
            ...
            <tr valign="top">
                <th scope="row" colspan="2" style="border-top:3px solid #ddd;">
                    <h3 style="padding-bottom:5px; padding-top:20px; font-weight:normal; margin:0px;"> Comment reporting
                        message from reporter to admin</h3>
                    <p class="wpd-info"> This message comes from comment reporting pop-up form. It includes reporter
                        message and bad comment category (reason).</p>
                </th>
            </tr>
            <tr valign="top">
                <th scope="row">
        ...
        &lt;p&gt;Comment URL | Text: [commentInfo]&lt;/p&gt;</textarea>
            ...
            <tr valign="top">
                <th scope="row" colspan="2" style="border-top:3px solid #ddd;">
                    <h3 style="padding-bottom:5px; padding-top:20px; font-weight:normal; margin:0px;"> Auto-moderation
                        notification to admin</h3>
                    <p class="wpd-info"> This message will be sent to admin once maximum number of flags or dislikes is
                        reached for certain comment and this comment is auto-moderated (trashed or unapproved)</p>
                </th>
            </tr>
            <tr valign="top">
                <th scope="row">
                    ...
                    <p class="wpd-info">Please do not remove %s variable at end of this phrase. This variable will be
                        changed to auto-moderation mode "flags" or "dislikes".</p>
                </th>
                <td>
                    <input name="" value="New comment has reached to the maximum number of %s"
                           id="wpdiscuz_moderated_email_subject" type="text">
                </td>
            </tr>
            <tr valign="top">
                <th scope="row">
