...
if (!$isAlExists) {
    ...
    <div style="width:100%;">
        ...
        <p style="border: 1px dotted #07B290; padding: 15px; font-size: 14px; text-align: center; margin: 10px; background: #EFFFF5">
            wpDiscuz Advanced Likers addon allows to see comment likers and voters. Adds user reputation and badges
            based on received likes.
            This is a demo admin page of the wpDiscuz Advanced Likers addon. You can buy this addon on gVectors Team
            Store.
            <br>
        ...
        <table class="wp-list-table widefat plugins" style="margin-top:10px; border:none; opacity: 0.6;">
            ...
            <tr class="wv_avatar_style" style="display: table-row;" valign="top">
                ...
                <td>
                    <input name="" max="120" min="24" value="64" id="avatar-size"
                           oninput="amount.value=wv_avatar_size.value" type="range">
                ...
                <th colspan="2">
                    ...
                    <div style="width:100%;">
                        ...
                        <div class="wv_level_box">
                            ...
                            <div><input placeholder="Badge Icon" name="" value="fa-certificate" type="text">
                                <label><input name="" value="1" checked="" type="checkbox"> Enable</label>
                            </div>
                            <div><input placeholder="Custom Label" name="" value="Trusted Member" type="text">
                                <label><input name="" value="1" checked="" type="checkbox"> Enable</label>
                            </div>
                        </div>
                        <div class="wv_level_box">
                            ...
                            <div><input placeholder="Badge Icon" name="" value="fa-shield-alt" type="text">
                                <label><input name="" value="1" checked="" type="checkbox"> Enable</label>
                            </div>
                            <div><input placeholder="Custom Label" name="" value="Noble Member" type="text">
                                <label><input name="" value="1" checked="" type="checkbox"> Enable</label>
                            </div>
                        </div>
                        <div class="wv_level_box">
            ...
            <tr valign="top">
                ...
                <td>
                    <input class="wpdiscuz-color-picker regular-text" value="#FDFDFD" id="voters_background_color"
                           name="" placeholder="Example: #00FF00"
                           style="background-color: rgb(253, 253, 253); color: rgb(34, 34, 34);" type="text">
                    <!--<label-->
                </td>
            </tr>
            <tr valign="top">
                ...
                <td>
                    <input class="wpdiscuz-color-picker regular-text" value="#000" id="voters_border_color" name=""
                           placeholder="Example: #00FF00"
                           style="background-color: rgb(0, 0, 0); color: rgb(221, 221, 221);" type="text">
                </td>
            </tr>
            <!--
                    <tr valign="top">
        ...
        Vote dislike default color                                        </span>
            ...
            <tr valign="top">
                ...
                <td>
                    <input class="wpdiscuz-color-picker regular-text" value="#00bc74" id="voters_background_color"
                           name="" placeholder="Example: #00FF00"
                           style="background-color: rgb(0, 188, 116); color: rgb(34, 34, 34);" type="text">
                </td>
            </tr>
            <tr valign="top">
                <th>
                ...
                <td>
                    <input class="wpdiscuz-color-picker regular-text" value="#ff5959" id="voters_background_color"
                           name="" placeholder="Example: #00FF00"
                           style="background-color: rgb(255, 89, 89); color: rgb(34, 34, 34);" type="text">
                </td>
            </tr>
            <tr valign="top">
                <th>
                ...
                <td>
                    <input class="wpdiscuz-color-picker regular-text" value="#FFF" id="voters_background_color" name=""
                           placeholder="Example: #00FF00"
                           style="background-color: rgb(255, 255, 255); color: rgb(34, 34, 34);" type="text">
                </td>
            </tr>
            <tr valign="top">
                <th>
