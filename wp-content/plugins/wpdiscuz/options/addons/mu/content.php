...
if (!$isMuExists) {
    ...
    <div style="width:100%;">
        ...
        <p style="border: 1px dotted #07B290; padding: 15px; font-size: 14px; text-align: center; margin: 10px; background: #EFFFF5">
            wpDiscuz Media Uploader is an extended comment attachment system. Allows to upload images, videos, audios
            and other file types.
            This is a demo admin page of the wpDiscuz Media Uploader addon. You can buy this addon on gVectors Team
            Store.
            <br>
        ...
        <table class="widefat wpdiscuz-mu" style="margin-top:10px; border:none; width:100%; opacity: 0.6">
            ...
            <tr scope="row">
                ...
                <td>
                    <div style="float:left; display:inline-block; padding:3px 5px 3px 7px; min-width:25%;">
                        <input type="checkbox" checked='checked' value="post" name="" id="wmupost"
                               style="margin:0px; vertical-align: middle;"/>
                        <label for="wmupost" style="white-space:nowrap; font-size:13px;">post</label>
                    </div>
                    <div style="float:left; display:inline-block; padding:3px 5px 3px 7px; min-width:25%;">
                        <input type="checkbox" checked='checked' value="page" name="" id="wmupage"
                               style="margin:0px; vertical-align: middle;"/>
                        <label for="wmupage" style="white-space:nowrap; font-size:13px;">page</label>
                    </div>
                    <div style="float:left; display:inline-block; padding:3px 5px 3px 7px; min-width:25%;">
                        <input type="checkbox" checked='checked' value="attachment" name="" id="wmuattachment"
                               style="margin:0px; vertical-align: middle;"/>
            ...
            <tr scope="row">
                ...
                <td>
                    <div style="float:left; display:inline-block; padding:3px 5px 3px 7px; min-width:25%;">
                        <input type="checkbox" checked='checked' value="administrator" name="" id="wmuadministrator"
                               style="margin:0px; vertical-align: middle;"/>
                        <label for="wmuadministrator" style="white-space:nowrap; font-size:13px;">Administrator</label>
                    </div>
                    <div style="float:left; display:inline-block; padding:3px 5px 3px 7px; min-width:25%;">
                        <input type="checkbox" checked='checked' value="editor" name="" id="wmueditor"
                               style="margin:0px; vertical-align: middle;"/>
                        <label for="wmueditor" style="white-space:nowrap; font-size:13px;">Editor</label>
                    </div>
                    <div style="float:left; display:inline-block; padding:3px 5px 3px 7px; min-width:25%;">
                        <input type="checkbox" checked='checked' value="author" name="" id="wmuauthor"
                               style="margin:0px; vertical-align: middle;"/>
                        <label for="wmuauthor" style="white-space:nowrap; font-size:13px;">Author</label>
                    </div>
                    <div style="float:left; display:inline-block; padding:3px 5px 3px 7px; min-width:25%;">
                        <input type="checkbox" checked='checked' value="contributor" name="" id="wmucontributor"
                               style="margin:0px; vertical-align: middle;"/>
                        <label for="wmucontributor" style="white-space:nowrap; font-size:13px;">Contributor</label>
                    </div>
                    <div style="float:left; display:inline-block; padding:3px 5px 3px 7px; min-width:25%;">
                        <input type="checkbox" checked='checked' value="subscriber" name="" id="wmusubscriber"
                               style="margin:0px; vertical-align: middle;"/>
                        <label for="wmusubscriber" style="white-space:nowrap; font-size:13px;">Subscriber</label>
                    </div>
                    <div style="float:left; display:inline-block; padding:3px 5px 3px 7px; min-width:25%;">
                        <input type="checkbox" value="customer" name="" id="wmucustomer"
                               style="margin:0px; vertical-align: middle;"/>
                        <label for="wmucustomer" style="white-space:nowrap; font-size:13px;">Customer</label>
                    </div>
                    <div style="float:left; display:inline-block; padding:3px 5px 3px 7px; min-width:25%;">
                        <input type="checkbox" value="shop_manager" name="" id="wmushop_manager"
                               style="margin:0px; vertical-align: middle;"/>
            ...
            <tr scope="row">
                <th>
                    ...
                    <p style="font-size:13px; color:#999999; width:98%; padding-left:0px; margin-left:0px;">This
            ...
            <tr scope="row">
                <th>
                    ...
                    <p style="font-size:13px; color:#999999; width:98%; padding-left:0px; margin-left:0px;">This is the
                        auto-embed function which converts e.g. <strong>YouTube</strong> video URL to Embedded Player
                        and so on...</p>
                </th>
            ...
            <tr scope="row">
                <th>
                    ...
                    <p style="font-size:13px; color:#999999; width:98%; padding-left:0px; margin-left:0px;">Uploaded
                        video files will be added as a download link under comment text. However if file format is .mp4,
            ...
            <tr scope="row">
                ...
                <td>
                    <fieldset>
                        <label for="wmuAttachSingle"><input type="radio" value="0" id="wmuAttachSingle"
                                                            class="wmuAttachSingle wmuAttachMethod" name=""/>&nbsp;&nbsp;<span>Single</span></label>
                        <label for="wmuAttachMultiple"><input checked='checked' type="radio" value="1"
                                                              id="wmuAttachMultiple"
                                                              class="wmuAttachMultiple wmuAttachMethod" name=""/>&nbsp;&nbsp;<span>Multiple</span></label>
                    </fieldset>
                </td>
            </tr>
            ...
            <tr scope="row">
                <th>
                    ...
                    <p style="font-size:13px; color:#999999; width:98%; padding-left:0px; margin-left:0px;">You can not
                        set this value more than "upload_max_filesize" and "post_max_size". If you want to increase
                        server parameters please contact to your hosting service support.</p>
                </th>
                <td>
            ...
            <tr scope="row">
                ...
                <td>
                    <input type="number" value="320" name="" id="wmuVideoWidth"
                           class="wmu-number"/><span> width (px) </span>
                    <input type="number" value="200" name="" id="wmuVideoHeight"
                           class="wmu-number"/><span> height (px) </span>
                </td>
            </tr>
            <tr scope="row">
            ...
            <tr scope="row">
                ...
                <td>
                    <input type="number" value="90" name="" id="wmuImageWidth"
                           class="wmu-number"/><span> width (px) </span>
                    <input type="number" value="90" name="" id="wmuImageHeight"
                           class="wmu-number"/><span> height (px) </span>
                </td>
            </tr>
            </tbody>
