        ...
        <div class="wpdtool wpdtool-rebuild-ratings">
            ...
            <form action="" method="post" class="wc-tools-settings-form wc-form">
                ...
                <div class="wpdtool-block">
                    <button <?php echo $disabledratings; ?> type="submit"
                                                            class="button button-secondary rebuild-ratings"
                                                            title="<?php esc_attr_e("Start Rebuild", "wpdiscuz"); ?>">
                    ...
                    <input type="hidden" name="rebuild-ratings-count"
                           value="<?php echo esc_attr($rebuildRatingsCount); ?>" class="rebuild-ratings-count"/>
